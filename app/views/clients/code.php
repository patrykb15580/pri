...
<div class="client-view-title-box">
	<i class="fa fa-ticket client-view-title-icon orange-icon" aria-hidden="true"></i><p class="client-view-title-text">Wprowadź kod</p>
</div>

<form class="guardian-initialize client-view-item-box" method="POST" action="<?= $path ?>">
	<input type="text" name="code" required="required" placeholder="Wprowadź swój kod" maxlength="6">
